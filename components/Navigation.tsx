...
const Navigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 bg-white/80 dark:bg-black/80 backdrop-blur-md border-t border-gray-200/50 dark:border-gray-800/50 safe-area-pb">
